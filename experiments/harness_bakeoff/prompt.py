...
def build_prompt(icp: dict[str, Any], max_companies: int | None = None) -> str:
    ...
    return (
        ...
        "untested queue until the requested limit is filled or the queue, budget, or deadline is exhausted. A "
        "verified_example_company is context, not proof. Use get_company_profile or one focused fit search only for "
